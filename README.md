...
This application is deployed into our kubernetes clusters using the helm install from local source files. A python client to interface with this application can be found in the vtg-qa-propeller repo
